...
2. Pe based on industy: Since we are looking for value stocks we have to try to find earnings that are cheap based on the rest of the industry averages(15 points)(implememted and tested with a temporary average pe that isnt based on industry)
